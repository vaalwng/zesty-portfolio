    ...
    return (
        <div>
            <div className="flex items-center justify-center flex-col text-center pt-20 pb-6">
                <h1 className="text-4xl md:text-7xl mb-1 md:mb-3 font-bold tracking-wide">Val Evander M. Wong</h1>
                <p className="text-base md:text-xl mb-3 font-medium tracking-wide">Software Development Engineer @ NETSCOUT</p>
                <p className="text-base md:text-l mb-3 font-medium tracking-wide">University of Texas at Dallas Software Engineering Magna Cum Laude</p>
